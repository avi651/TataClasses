...
import 'package:tat_edge/presentation/quiz_question.dart';

import 'home.dart';

class ResultPage extends StatefulWidget {
  final QuestionOptionBox questionOptionBox;
  const ResultPage(this.questionOptionBox, {Key key}) : super(key: key);
    ...
    Future.delayed(const Duration(milliseconds: 600), () {
      ...
      Future.delayed(const Duration(milliseconds: 700), () {
        ...
        Future.delayed(const Duration(milliseconds: 1000), () {
          ...
          Future.delayed(const Duration(milliseconds: 1000), () {
            //Here we have to check the answer then after we have to navigate
